...
Ambos os autores colaboraram nas discussões e validação dos resultados, participando juntos na resolução e entendimento das questões colocadas.
...
- `codigos/`: em suas subpastas estão os scripts em R responsáveis pelas análises e geração de figuras de cada questão.
